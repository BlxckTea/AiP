...
rm_y = -2.0
rm_z = -2.0
saveCnt = 30 # ns = n*10 :: 간격 3000=5min

def saveText(max_x, max_y, max_z, rm_x, rm_y, rm_z):
	print("### Save start ###")
...
while True:
	...
	print([rm_x, rm_y, rm_z]) # 현재 측정값 확인
	...
	if (stop - start ) >= 300.0 and (stop - start) < 301.0:
		saveCnt = saveText(max_x, max_y, max_z, rm_x, rm_y, rm_z)
		max_x = 0.0
		max_y = 0.0
		max_z = 0.0
		old_x = read_raw_data(ACCEL_XOUT_H) / 16384.0
